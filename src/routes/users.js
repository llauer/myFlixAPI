...
router.get('/users/:Username', passport.authenticate('jwt', { session: false }), function(req, res) {
...
router.get('/users/:Username/Movies', passport.authenticate('jwt', { session: false }), (req, res) => {
...
router.post('/users/:Username/Movies/:MovieID', passport.authenticate('jwt', { session: false }), (req, res) => {
